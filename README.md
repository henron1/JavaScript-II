...
* [y] To test your `console.log()` statements, open up the index.html file found in the assignments folder and use the developer tools to view the console.  
...
* [y] Review the contents of the [callbacks.js](assignments/callbacks.js) file.  Notice you are given an array at the top of the page.  Use that array to aid you with your callback functions.

* [y] Write out each function using the `ES5`  `function` keyword syntax.

* [y] Solve the problems listed.  Save the stretch problems until you have completed Tasks 1-4.

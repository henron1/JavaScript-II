...
// Problem 1 create and email list
const emails = runners.map(runner => runner.email);
console.log(emails)

// Problem 2 name plus company

let nameCompany = [];
runners.forEach(function(name){
    console.log(name.first_name + ` ` + name.last_name + ` is from ` + name.company_name)
})
console.log(fullName);

// Problem 3 name plus shirt size
let nameSize = [];
runners.forEach(function(name){
    console.log(name.first_name+ ` ` + name.last_name + `'s shirt size is ` + name.shirt_size )
});
